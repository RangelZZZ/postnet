...
const postnet1 = require('../main/postnet1');
    ...
    describe('barcode2Zipcode', () => {
        it('should translate barcode to zipcode', () => {
            [
                ...
                const result = postnet1.barcode2Zipcode(example.barcode);
                expect(result.success).toBeTruthy();
        ...
        it('should validate barcode format', () => {
            [':|::|:|:|:||::::|:|::||::||:::'].forEach((barcode) => {
                const result = postnet1.barcode2Zipcode(barcode);
                expect(result.success).toBeFalsy();
        ...
        it('should validate zipcode by check digit', () => {
            const result = postnet1.barcode2Zipcode('|:|::|:|:|:||::::|:|::||:::::|||');
            expect(result.success).toBeFalsy();
